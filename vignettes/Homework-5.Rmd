...
I'm setting all the evaluation 
...
In Professor Kane's example, we use 
...
According to the plot, the neural network with mean absolute deviation as a 
loss function works well to capture the relationship between X and y.
